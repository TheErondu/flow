        ...
        children: <Widget>[
          ...
          Flexible(
            child: Padding(
              ...
              child: Text(
                ...
                style: TextStyle(decoration: TextDecoration.none, fontWeight: FontWeight.w500, fontSize: 20,color: Colors.white),
              ),
            ),
          ),
          SizedBox(
          ...
          Padding(
            ...
            child: Text(
              ...
              softWrap: true,
              textAlign: TextAlign.center,
              style: TextStyle(decoration: TextDecoration.none, fontWeight: FontWeight.w500, fontSize: 14,color: Colors.white),
            ),
          ),
        ],
      ),
