...
class GraphicsLogsNewsWidget extends StatefulWidget {
  const GraphicsLogsNewsWidget({Key key}) : super(key: key);

  @override
  _GraphicsLogsNewsWidgetState createState() => _GraphicsLogsNewsWidgetState();
}
...
class _GraphicsLogsNewsWidgetState extends State<GraphicsLogsNewsWidget> {
  ...
  void initState() {
    ...
    getGraphicsLogs = getGraphicsLogsCall();
  }
