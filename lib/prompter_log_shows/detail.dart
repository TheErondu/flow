                          ...
                          child: Row(
                            ...
                            children: [
                              Padding(
                                ...
                                child: Text(data['prompter_log_shows'][iD]['segment']
                                      .toString(),
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text(data['prompter_log_shows'][iD]['created_at']
                                      .toString(),
                              ...
                              Padding(
                                padding:
                                    EdgeInsetsDirectional.fromSTEB(4, 0, 0, 0),
                                child: Text(data['prompter_log_shows'][iD]['rundown_in']
                                      .toString(),
                                  style: FlutterFlowTheme.bodyText1.override(
                                    fontFamily: 'Poppins',
                                    color: FlutterFlowTheme.primaryColor,
                            ...
                            children: [
                              Expanded(
                                child: Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      0, 4, 0, 4),
                                  child: Text(data['prompter_log_shows'][iD]['challenges']
                                      .toString(),
