...
class PrompterLogsShowsWidget extends StatefulWidget {
  const PrompterLogsShowsWidget({Key key}) : super(key: key);

  @override
  _PrompterLogsShowsWidgetState createState() => _PrompterLogsShowsWidgetState();
}

class _PrompterLogsShowsWidgetState extends State<PrompterLogsShowsWidget> {
