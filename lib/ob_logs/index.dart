...
class OBLogsWidget extends StatefulWidget {
  const OBLogsWidget({Key key}) : super(key: key);

  @override
  _OBLogsWidgetState createState() => _OBLogsWidgetState();
}

class _OBLogsWidgetState extends State<OBLogsWidget> {
   Future<dynamic> getOblogs;
